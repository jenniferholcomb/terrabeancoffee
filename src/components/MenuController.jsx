...
class MenuController extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      cartItems: [],
      cartSubtotal: 0,
      introParagraph: 'Terra Bean Coffee Co. is built on one simple premise: deliver exceptional coffee while being reverent to the environment and community it comes from. Procuring the finest beans, we delicately roast to highlight unique flavors. Committed to sustainability, we prioritize ethical sourcing, eco-friendly practices, and responsible stewardship of the earth.',
