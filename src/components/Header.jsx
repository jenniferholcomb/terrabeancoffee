...
function Header({logoTranslateY, logoTranslateYNrw, logoTranslateYTablet, logoTranslateYTabletPor, logoTranslateYMobile, isWdDesktop, isTablet, isTabletPor, isMobile, orientation, isScrolledLogo, isScrolled}) {
  ...
  return (
    <React.Fragment>
      <header className='mast-head'>
        ...
        >
          <img 
            className={`${isScrolledLogo && isMobile ? "logoMobileScrolled" : "logo"}`} 
            src={logo} 
            alt="Terra Bean Coffee Co logo" 
            style={{
